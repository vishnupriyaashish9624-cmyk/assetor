...
const doc = new Document({
    sections: [{
        ...
        children: [
            ...
            new Paragraph({
                text: "Full Feature & Submodule Breakdown (All Includes + Vehicles)",
...
Packer.toBuffer(doc).then((buffer) => {
    fs.writeFileSync("../TRakio_All_Modules_Documentation.docx", buffer);
    console.log("----------------------------------------");
    console.log("✅ New All Modules Document Created with Vehicle Module!");
    console.log("Location: d:/Asset Web/TRakio_All_Modules_Documentation.docx");
    console.log("----------------------------------------");
}).catch(err => {
